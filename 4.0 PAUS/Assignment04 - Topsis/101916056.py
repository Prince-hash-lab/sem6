    ...
    if n==5:
        ...
        for i in sys.argv[2]:
            if(i.isnumeric()==False and i!=',' and i!='.' ):
                c1=c1+1
        for i in sys.argv[3]:
            if(i.isnumeric()==False and i!='+' and i!='-' and i!=',' and i!='.'):
                c2=c2+1
        ...
        print("wrong input please pass in the form of {python_file_name inputFileName  Weights  Impacts resultFileName ")
        sys.exit()
